...
def make_feature_builder(
    ...
    """
    macro_cols = list(dict.fromkeys(cfg.macro_cols))
    # Keep split/group date out of feature set.
    char_cols = [c for c in dict.fromkeys(cfg.char_cols) if c != cfg.date_col]
