...
def main() -> None:
    ...
    res_mlp = run_gkx_mlp(
        ...
        use_plateau_scheduler=TRAIN_CFG.use_plateau_scheduler,
        plateau_factor=TRAIN_CFG.plateau_factor,
        plateau_patience=TRAIN_CFG.plateau_patience,
        plateau_min_lr=TRAIN_CFG.plateau_min_lr,
        plateau_threshold=TRAIN_CFG.plateau_threshold,
        ensemble_n=5,
        deterministic=True,
        l1_lambda=1e-3,
    )
